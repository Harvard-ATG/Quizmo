<form id="quiz-form" class="form-horizontal row-fluid isites-form" action="/quiz/create">
	<fieldset>
		...
		<?php echo $this->renderPartial('_form', array('collection_id'=>$collection_id, 'title'=>$title, 'description'=>$description, 'state'=>$state, 'start_date'=>$start_date, 'end_date'=>$end_date, 'quiz_id'=>$quiz_id)); ?>
	</fieldset>
</form>
