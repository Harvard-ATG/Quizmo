...
window.rangy = function () {
    ...
    function g() {
        if (!o.initialized) {
            var a, d = !1,
                h = !1;
            b(document, "createRange") && (a = document.createRange(), m(a, p) && x(a, n) && (d = !0), a.detach());
    ...
    o.requireModules = function (a) {
        for (var b = 0, c = a.length, d, h; b < c; ++b) {
            h = a[b];
            d = o.modules[h];
...
rangy.createModule("DomUtil", function (b, c) {
    ...
    b.dom = {
        ...
        isHtmlNamespace: function (a) {
            var b;
            return typeof a.namespaceURI == p || null === (b = a.namespaceURI) || "http://www.w3.org/1999/xhtml" == b
        },
...
rangy.createModule("DomRange", function (b) {
    ...
    function g(a, b, c) {
        ...
        l.isCharacterDataNode(b) ? c == b.length ? l.insertAfter(a, b) : b.parentNode.insertBefore(a, 0 == c ? b : l.splitDataNode(b, c)) : c >= b.childNodes.length ? b.appendChild(a) : b.insertBefore(a, b.childNodes[c]);
        return d
    }
    function i(b) {
    ...
    function h(a, b, c) {
        for (var d, e, c = c || {
            stop: !1
        }; d = a.next();) if (a.isPartiallySelectedSubtree()) if (!1 === b(d)) {
            c.stop = !0;
            break
        } else {
    ...
    function I(a, d, h) {
        ...
        b.util.extend(a.prototype, {
            ...
            normalizeBoundaries: function () {
                ...
                k ? l.isCharacterDataNode(a) ? 0 == b && j(a) : b < a.childNodes.length && (e = a.childNodes[b]) && l.isCharacterDataNode(e) && j(e) : (a = c, b = h);
                d(this, a, b, c, h)
            },
    ...
    function J(a, b, c, h, e) {
        var j = a.startContainer !== b || a.startOffset !== c,
    ...
    q.prototype = {
        ...
        remove: function () {
            var a = this._current,
                b, c;
            l.isCharacterDataNode(a) && (a === this.sc || a === this.ec) ? (b = a === this.sc ? this.so : 0, c = a === this.ec ? this.eo : a.length, b != c && a.deleteData(b, c - b)) : a.parentNode && a.parentNode.removeChild(a)
        },
    ...
    D.prototype = {
        ...
        cloneContents: function () {
            ...
            if (this.startContainer === this.endContainer && l.isCharacterDataNode(this.startContainer)) return b = this.startContainer.cloneNode(!0), b.data = b.data.slice(this.startOffset, this.endOffset), c = a(this).createDocumentFragment(), c.appendChild(b), c;
            c = new q(this, !0);
            b = i(c);
            c.detach();
            return b
        ...
        createContextualFragment: S ? function (a) {
        ...
        isPointInRange: function (a, b) {
            ...
            t(a, "HIERARCHY_REQUEST_ERR");
            y(a, this.startContainer);
            return 0 <= l.comparePoints(a, b, this.startContainer, this.startOffset) && 0 >= l.comparePoints(a, b, this.endContainer, this.endOffset)
        },
...
rangy.createModule("WrappedRange", function (b) {
    function c(a, b, c, d) {
        ...
        do i.insertBefore(b, b.previousSibling), g.moveToElementText(b);
        while (0 < (r = g.compareEndPoints(m, a)) && b.previousSibling);
        m = b.nextSibling;
    ...
    if (b.features.implementsDomRange && (!b.features.implementsTextRange || !b.config.preferTextRange))(function () {
        function a(b) {
            for (var c = j.length, d; c--;) d = j[c], b[d] = b.nativeRange[d]
        }
        ...
        c.selectNodeContents = q.startContainer == i && q.endContainer == i && 0 == q.startOffset && q.endOffset == i.length ? function (b) {
...
rangy.createModule("WrappedSelection", function (b, c) {
        ...
        u.addRange = N ? function (a, c) {
            if (l && v && this.docSelection.type == "Control") j(this, a);
                ...
                if (this.rangeCount == d + 1) {
                    if (b.config.checkSelectionRanges)(d = B(this.nativeSelection, this.rangeCount - 1)) && !x.rangesEqual(d, a) && (a = new o(d));
    ...
    } else if (s.isHostMethod(t, "empty") && s.isHostMethod(K, "select") && l && D) u.removeAllRanges = function () {
        try {
    ...
    u.containsNode = function (a, b) {
        for (var c = 0, d = this._ranges.length; c < d; ++c) if (this._ranges[c].containsNode(a, b)) return true;
        return false
    };
    u.toHtml = function () {
        var a = "";
...
Base = Base.extend({
    ...
    implement: function () {
        for (var b = 0; b < arguments.length; b++) if ("function" == typeof arguments[b]) arguments[b](this.prototype);
    ...
    return function (c, a) {
        ...
        if ("object" === typeof c && c.nodeType) d = a.createElement("div"), d.appendChild(c);
            ...
            if (!d._wysihtml5_supportsHTML5Tags) {
                for (var e = 0, f = b.length; e < f; e++) d.createElement(b[e]);
...
wysihtml5.dom.observe = function (b, c, a) {
    ...
    return {
        stop: function () {
            for (var e, h = 0, f = c.length; h < f; h++) e = c[h], b.removeEventListener ? b.removeEventListener(e, a, !1) : b.detachEvent("on" + e, d)
        }
    }
};
wysihtml5.dom.parse = function () {
    ...
    var a = {
        1: function (a) {
            ...
            (A = a.getAttribute("class")) && (w = w.concat(A.split(e)));
    ...
    return function (a, c, d, e) {
        ...
        a.innerHTML = "";
        a.appendChild(c);
        return h ? wysihtml5.quirks.getCorrectInnerHTML(a) : a
    }
}();
        ...
        _onLoadIframe: function (f) {
            if (b.dom.contains(c.documentElement, f)) {
                ...
                if (!b.browser.supportsSandboxedIframes()) {
                    ...
                    k = 0;
                    for (j = e.length; k < j; k++) this._unset(h, e[k]);
...
wysihtml5.dom.setStyles = function (b) {
    return {
        on: function (c) {
            ...
            else for (var a in b) "float" === a ? (c.cssFloat = b[a], c.styleFloat = b[a]) : c[a] = b[a]
        }
    }
};
(function (b) {
    ...
    b.Selection = Base.extend({
        ...
        executeAndRestoreSimple: function (a) {
            ...
            if (f) {
                ...
                b = g === f.startContainer ? f.startOffset : 0;
        ...
        scrollIntoView: function () {
            ...
            if (c) {
                ...
                var c = e,
                    f = 0;
                if (c.parentNode) {
                    do f += c.offsetTop || 0, c = c.offsetParent;
                    while (c)
                }
                c = f;
                e.parentNode.removeChild(e);
                c > a.body.scrollTop && (a.body.scrollTop = c)
            }
        },
        selectLine: function () {
...
(function (b, c) {
    ...
    f.prototype = {
        ...
        postApply: function (a, b) {
            ...
            if (f.length) {
                w = 0;
                for (y = f.length; w < y; ++w) f[w].doMerge();
                b.setStart(i, s);
                b.setEnd(m, x)
            }
        },
...
(function (b) {
    ...
    function e(a, c, d, e) {
        if (e) var f = g.observe(a, "DOMNodeInserted", function (a) {
            var a = a.target,
                c;
            a.nodeType === b.ELEMENT_NODE && (c = g.getStyle("display").from(a), "inline" !== c.substr(0, 6) && (a.className += " " + e))
        });
        a.execCommand(c, !1, d);
        f && f.stop()
    }
    ...
    b.commands.formatBlock = {
        exec: function (h, k, j, n, p) {
            var q = h.doc,
                ...
                m, j = "string" === typeof j ? j.toUpperCase() : j;
...
(function (b) {
    ...
    b.toolbar.Toolbar = Base.extend({
        ...
        _getLinks: function (a) {
            for (var c = this[a + "Links"] = b.lang.array(this.container.querySelectorAll("[data-wysihtml5-" + a + "]")).get(), e = c.length, f = 0, g = this[a + "Mapping"] = {}, i, h, k, j, n; f < e; f++) i = c[f], k = i.getAttribute("data-wysihtml5-" + a), j = i.getAttribute("data-wysihtml5-" + a + "-value"), h = this.container.querySelector("[data-wysihtml5-" + a + "-group='" + k + "']"), n = this._getDialog(i, k), g[k + ":" + j] = {
                link: i,
                group: h,
                name: k,
                value: j,
